...
namespace PlaneBooking.Database.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaneDepartures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlaneDepartures_Planes_PlaneId",
                        column: x => x.PlaneId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaneDepartures_PlaneId",
                table: "PlaneDepartures",
                column: "PlaneId");
